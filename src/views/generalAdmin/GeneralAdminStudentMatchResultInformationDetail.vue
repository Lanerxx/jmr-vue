      ...
      <template v-slot:top>
        <v-toolbar flat color="white">
          ...
          <v-btn
            ...
            fab
            color="teal"
            to="/generalAdminStudentMatchResultInformation"
          >
            返回
          </v-btn>
...
<script>
import { LIST_STUDENT_MATCH_RESULT_ADMIN } from "@/store/types.js";
import { GET_COMPANY_ADMIN } from "@/store/types.js";
import { mapState } from "vuex";
export default {
  props: ["cid"],
  created() {
    this.$store.dispatch(LIST_STUDENT_MATCH_RESULT_ADMIN, {
      cid: this.$route.params.cid
    });
    this.$store.dispatch(GET_COMPANY_ADMIN, {
      cid: this.$route.params.cid
    });
  },
  data: () => ({
