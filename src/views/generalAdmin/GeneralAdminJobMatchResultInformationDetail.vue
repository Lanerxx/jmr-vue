      ...
      <template v-slot:top>
        <v-toolbar flat color="white">
          ...
          <v-btn
            ...
            fab
            color="teal"
            to="/generalAdminJobMatchResultInformation"
          >
            返回
          </v-btn>
...
<script>
import { LIST_JOB_MATCH_RESULT_ADMIN } from "@/store/types.js";
import { GET_STUDENT_ADMIN } from "@/store/types.js";
import { mapState } from "vuex";
export default {
  props: ["sid"],

  created() {
    this.$store.dispatch(LIST_JOB_MATCH_RESULT_ADMIN, {
      sid: this.$route.params.sid
    });
    this.$store.dispatch(GET_STUDENT_ADMIN, {
      sid: this.$route.params.sid
    });
